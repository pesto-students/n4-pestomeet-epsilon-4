...
describe('List User Route Testing', function() {
    it('should list user by status and role', function(done) {
        let status = "approved"
        let role="mentor"
        let regex=/[0-900] users on approved Status/
        chai.request(host).get('/api/pesto/list/user/'+status+'/'+role)
