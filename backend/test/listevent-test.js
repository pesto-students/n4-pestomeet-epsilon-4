...
describe('List Event Route Testing', function() {
    it('should list event by its type', function(done) {
        let type = "masterclass"
        let regex=/[0-900] masterclass Event Found/
        chai.request(host).get('/api/pesto/list/event/'+type)
